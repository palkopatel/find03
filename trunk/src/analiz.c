...
int split_path_f_filename(char *filename, char *path)
{
...
/*-------------------------------------*/
int false_file_type(char* filename)
{
...
int is_mini_separator(char sim)
{
...
int parse_href(char* str1, char* linkname)
{
